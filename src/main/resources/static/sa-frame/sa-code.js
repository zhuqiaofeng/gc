...
// 设置模板标题 
sa_admin.title = "工监后台系统";
sa_admin.logo = 'sa-frame/admin-logo01.jpeg';    // 设置logo图标地址
sa_admin.icon = 'sa-frame/admin-logo01.jpeg';    // 设置icon图标地址
...
sa_admin.user = {
	username: 'root',	// 昵称 
	avatar: 'sa-frame/admin-logo01.jpeg'	// 头像地址
}
