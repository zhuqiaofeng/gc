...
var menuList =	[
	{
		...
		childList: [
			...
			{id: '2-3', name: '新建工程', url: 'sa-view/case/submit-form.html'},
	...
	},
	{
		...
		info: '首页的一些设置',
		childList: [
            {id: '3-1-6', name: '总项目', icon: 'el-icon-eleme', url: ''},
            {id: '3-1-7', name: '项目分部', icon: 'el-icon-plus', url: ''},
            {id: '3-1-8', name: '项目分项', icon: 'el-icon-eleme', url: ''},
	...
	},
	{
		...
		childList: [
            ...
            {id: '4-3', name: '用户管理', icon: 'el-icon-document-remove', url: 'sa-view/user/user-list.html'},
            {id: '4-5', name: '用户管理', icon: 'el-icon-document-remove', url: 'sa-view/user/user-update.html',isShow: false},
            {id: '4-4', name: '用户添加', icon: 'el-icon-plus', url: 'sa-view/user/user-add.html',isShow: false}
		]
	},
	/*{
		id: '5',
	...
	},
	{
		...
		childList: [
			...
			{id: '7-10', name: '有错误', url: 'sa-view/error-page/500.html'},
...
var menuList1 =	[
    ...
    },
    {
        ...
        childList: [
            ...
            {id: '7-8', name: '403无权限', url: 'sa-view/error-page/403.html'},
            {id: '7-9', name: '404未找到', url: 'sa-view/error-page/404.html'},
            {id: '7-10', name: '张三有错误', url: 'sa-view/error-page/500.html'},
            {id: '7-11', name: '服务器设置', url: 'sa-view/cfg/system-cfg.html', info: '对服务器参数的设置'},
