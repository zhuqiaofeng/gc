...
public class AttendanceServiceImpl extends ServiceImpl<AttendanceDao, Attendance> implements AttendanceService {
     ...
     */
    @Override
    public List<AttendanceVo> findAttendanceList(Integer curr_page, Integer page_size, String userName) {
        //计算偏移量 = (当前页-1)*每页显示条数
        Integer pyl = (curr_page-1)*page_size;

        List<AttendanceVo> attendances = attendanceDao.findAttendanceList(pyl,page_size,userName);
        return attendances;
    }
